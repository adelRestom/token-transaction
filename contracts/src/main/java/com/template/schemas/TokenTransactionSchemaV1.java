...
public class TokenTransactionSchemaV1 extends MappedSchema {
    ...
    public TokenTransactionSchemaV1() {
        super(TokenTransactionSchema.class, 1, Collections.singletonList(PersistenTokenTransaction.class));
    }

    @Entity
    @Table(name = "token_transactions")
    public static class PersistenTokenTransaction extends PersistentState {
        ...
        public PersistenTokenTransaction(String linearId, String explorer, Instant timestamp, String type,
        ...
        public PersistenTokenTransaction() {
            this.linearId = null;
            this.explorer = null;
            this.timestamp = null;
            this.type = null;
